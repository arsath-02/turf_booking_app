...
class _TurfBookingScreenState extends State<TurfBookingScreen> {
  ...
  late Future<List<Turf>> _turfs = Future.value([]); // Initialize turfs
  ...
  Future<void> _getCurrentLocation() async {
    ...
    // Get city name from the position using reverse geocoding
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        color: Colors.green[200], // Set the background color
        child: Column(
          children: [
            Padding(
                          ...
                          trailing: TextButton(
                            onPressed: () {
                              ...
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      TurfDetailsScreen(turfId: turf.id),
                                ),
                              );
                            },
                            child: Text('Review'),
